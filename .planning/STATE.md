...
last_updated: "2026-09-07T12:55:00.000Z"
last_activity: 2026-09-07 -- Quick task 260907-dow: corrigido defeito onde todo P2002 do Prisma 7 + driver adapter caia na mensagem generica de erro (meta.target nao existe mais nesse caminho); novo lib/prisma-error.ts extrai o campo colidido dos dois formatos, com prova RED->GREEN de 6 casos; email duplicado em /registro volta a devolver "Este email ja esta em uso."; 1171/1171 testes
progress:
  total_phases: 7
  completed_phases: 6
  total_plans: 48
...
Last activity: 2026-09-07 - Completed quick task 260907-fhk: Criar tela protegida no admin (ambos os modos SIMPLES e COMPLETO) para reler os Termos de Uso vigentes a qualquer momento
...
- ⚠️ [Phase 06] Texto jurídico da v1 dos termos ainda é o placeholder em PRODUÇÃO `[TEXTO PROVISORIO - ...]`. O texto real já existe versionado (`.planning/quick/260905-eqn-publicar-texto-real-dos-termos-de-uso-su/termos-de-uso-v2.txt`) e a ferramenta de publicação existe (`npm run termos:publicar`), com publicação provada contra a instância local (v27, sha256 conferido, v1 intacta — ver `260905-eqn-SUMMARY.md`). Falta a ação do operador em produção com credencial de produção e, antes dela, revisão jurídica (CDC/LGPD) do texto — foi redigido por IA e não revisado por advogado; pontos concretos de exposição no SUMMARY (limitação de responsabilidade x CDC, bloqueio sem exceções/sem reembolso proporcional, papéis controladora/operadora da LGPD)
...
| 260907-fhk | Criar tela protegida no admin (ambos os modos SIMPLES e COMPLETO) para reler os Termos de Uso vigentes a qualquer momento | 2026-09-07 | 7af2627 | [260907-fhk-criar-tela-protegida-no-admin-ambos-os-m](./quick/260907-fhk-criar-tela-protegida-no-admin-ambos-os-m/) |
